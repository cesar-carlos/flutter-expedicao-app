    ...
    group('INSERT Integration Tests', () {
      test(
        ...
        () async {
          ...
          expect(
            insertResult.first.item,
            newItem.item,
            reason: 'O número do item deve corresponder ao enviado',
          );
          expect(
            insertResult.first.sessionId,
            newItem.sessionId,
            reason: 'O sessionId deve corresponder ao enviado',
          );
          expect(
          ...
          expect(
            insertResult.first.codProduto,
            1,
            reason: 'O código do produto deve ser 1',
          );
          expect(
            insertResult.first.quantidade,
            1.0,
            reason: 'A quantidade deve ser 1.0',
          );
          expect(
    ...
    group('DELETE Integration Tests', () {
      test(
        ...
        () async {
          ...
          expect(
            deleteResult.first.item,
            insertedSeparationItem.item,
            reason: 'O número do item deve corresponder',
          );
          expect(
          ...
          expect(
            deleteResult.first.quantidade,
            1.0,
            reason: 'A quantidade deve permanecer a mesma',
          );
