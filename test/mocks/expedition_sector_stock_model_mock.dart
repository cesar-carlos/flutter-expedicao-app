...
ExpeditionSectorStockModel createUpdatedTestSectorStock(
  ExpeditionSectorStockModel originalSector,
) {
  return originalSector.copyWith(
    descricao: 'SETOR ATUALIZADO',
    ativo: Situation.inativo,
  );
}

ExpeditionSectorStockModel createInactiveSectorStock(
  ExpeditionSectorStockModel originalSector,
) {
