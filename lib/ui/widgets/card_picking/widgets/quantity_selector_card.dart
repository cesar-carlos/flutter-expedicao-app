...
class _QuantitySelectorCardState extends State<QuantitySelectorCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: widget.enabled ? Colors.orange.withOpacity(0.3) : Colors.grey.withOpacity(0.3),
          width: 2,
        ),
      ),
      child: Column(
  ...
  Widget _buildDecrementButton() {
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: widget.enabled ? Colors.orange.withOpacity(0.1) : Colors.grey.withOpacity(0.1),
