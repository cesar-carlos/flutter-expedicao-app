          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  'Usuário Selecionado',
                  style: AppFonts.inter(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.success),
                ),
              ],
            ),
            const SizedBox(height: 8),
            Text(user.nomeUsuario, style: AppFonts.inter(fontSize: 18, fontWeight: FontWeight.bold)),
