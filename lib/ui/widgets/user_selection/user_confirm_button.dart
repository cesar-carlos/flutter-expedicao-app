...
class UserConfirmButton extends StatelessWidget {
  ...
  const UserConfirmButton({super.key, required this.viewModel, required this.onConfirm});
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: viewModel.state == UserSelectionState.selecting
            ...
            : Text('Confirmar Seleção', style: AppFonts.inter(fontSize: 16, fontWeight: FontWeight.bold)),
      ),
    );
  }
}
