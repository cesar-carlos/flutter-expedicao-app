...
class TitleWithConnectionStatus extends StatelessWidget {
  final String? title;
  final Widget? titleWidget;
  final Widget Function(BuildContext context, SocketConnectionState connectionState)? titleBuilder;
  final Widget Function(BuildContext context)? dynamicTitleBuilder;

  const TitleWithConnectionStatus({
    super.key,
    this.title,
    this.titleWidget,
    this.titleBuilder,
  ...
  Widget _buildTitle(
    ...
    if (dynamicTitleBuilder != null) {
      return dynamicTitleBuilder!(context);
    }
