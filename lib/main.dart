      ...
      child: Consumer3<AuthViewModel, ThemeViewModel, AppUpdateViewModel>(
        builder:
            (
                  ...
                  if (mounted && !_updateDialogShown) {
                    ...
                    showDialog(
                      ...
                      builder: (_) => AppUpdateDialog(
                        release: appUpdateViewModel.updateAvailable!,
                      ),
                    ).then((_) {
              ...
              if ((appUpdateViewModel.isDownloading ||
                      appUpdateViewModel.isInstalling) &&
                  !_progressDialogShown) {
                WidgetsBinding.instance.addPostFrameCallback((_) {
              ...
              } else if (!appUpdateViewModel.isDownloading &&
                  !appUpdateViewModel.isInstalling &&
                  _progressDialogShown) {
                _progressDialogShown = false;
              }
