...
Result<T> validationFailure<T extends Object>(List<String> errors) => 
    Failure(ValidationFailure.fromErrors(errors));
...
Result<T> businessFailure<T extends Object>(String message) => 
    Failure(BusinessFailure(message: message));

/// Função helper para criar uma falha de autenticação
Result<T> authFailure<T extends Object>(String message) => 
    Failure(AuthFailure(message: message));

/// Função helper para criar uma falha desconhecida
Result<T> unknownFailure<T extends Object>(dynamic exception) => 
    Failure(UnknownFailure.fromException(exception));
